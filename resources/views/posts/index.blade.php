                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <form class="p-4 md:p-5" action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2">
                                            <label for="file-upload" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seleccionar Archivo</label>
                                            <input type="file" id="file-upload" name="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        </div>
                                    </div>
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <!-- Close modal button -->
                                        <button type="button" class="text-gray-700 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800" data-modal-toggle="crud-modal">
                                            Cerrar
                                        </button>
                                    </div>
                                </form>
                        ...
                        <tbody>
                            @foreach($posts as $post)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    <td class="px-6 py-4">
                                        <img src="{{ $post->image_url ? asset('storage/' . $post->image_url) : asset('default-placeholder.png') }}" alt="Post Image" class="w-24 h-24 object-cover">
                                    </td>
